        ...
        <div className="w-full">
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-xs sm:text-sm md:text-base lg:text-lg" style={{ color: 'var(--text-secondary)' }}>
                        Manage outings, users, and system settings
                    </p>
                </div>

                {/* Tab Navigation */}
                <div className="border-b mb-8" style={{ borderColor: 'var(--border-light)' }}>
                    <nav className="-mb-px flex flex-col sm:flex-row gap-2 sm:gap-0" aria-label="Tabs">
                        <button
                            ...
                            `}
                            style={{
                                borderColor: activeTab === 'outings' ? 'var(--color-primary)' : 'transparent',
                                color: activeTab === 'outings' ? 'var(--color-primary)' : 'var(--text-secondary)',
                                backgroundColor: activeTab === 'outings' ? 'rgba(var(--bsa-olive-rgb), 0.1)' : 'transparent',
                            }}
                        >
                            <svg
                        ...
                        <button
                            ...
                            `}
                            style={{
                                borderColor: activeTab === 'users' ? 'var(--color-primary)' : 'transparent',
                                color: activeTab === 'users' ? 'var(--color-primary)' : 'var(--text-secondary)',
                                backgroundColor: activeTab === 'users' ? 'rgba(var(--bsa-olive-rgb), 0.1)' : 'transparent',
                            }}
                        >
                            <svg
                                className="w-5 h-5 sm:w-6 sm:h-6"
                ...
                <div>
                    ...
                    {activeTab === 'users' && (
                        <div className="space-y-12">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>Development Tools</h2>
                                <DevDataSeeder />
                            </div>
                        </div>
                    )}
