...
const FamilySetupPage: React.FC = () => {
    ...
    if (!isLoaded || loading) {
        return (
            <div className="min-h-[calc(100vh-200px)] flex items-center justify-center p-5" style={{ backgroundColor: 'var(--bg-secondary)' }}>
    ...
    return (
        <div className="w-full min-h-screen" style={{ backgroundColor: 'var(--bg-secondary)' }}>
