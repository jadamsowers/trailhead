...
const ProfilePage: React.FC = () => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (
      ...
      !validatePhone(contactInfo.emergency_contact_phone)
    ) {
    ...
    try {
      ...
      setUser(updatedUser);
      setSuccessMessage(
        "Profile updated successfully! These details will be used as defaults for future signups."
      );
      ...
      <form onSubmit={handleSave}>
        ...
        >
          ...
          <p
            ...
            style={{ color: "var(--text-secondary)" }}
          >
            This information will be used as your default contact details for
            outing signups. You can change it for individual signups if needed.
          </p>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handlePhoneChange("emergency_contact_phone", e.target.value)
                  }
                  placeholder="(555) 123-4567"
                  className="w-full p-2.5 text-base rounded-md border"
                  style={{
            ...
            >
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  Please enter the expiration date from your Scouting America
                  SAFE Youth Training certificate.
                </p>
              </div>
            </div>
          </div>
